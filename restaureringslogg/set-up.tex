...
% Custom command for worklog-item display.
% Takes 4 parameters [date, short description, attendants, Description]
\newcommand{\worklogitem}[4]{
	\section{#1 - #2}
	\begin{tabular}{p{3cm} l}
		\multicolumn{1}{r}{\textbf{Tilstede:}} & #3\\
	\end{tabular}
	\\\\
	#4
}
